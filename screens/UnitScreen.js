  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style= {styles.unitOneContainer} onPress={() => {
        ...
        <Text style={styles.unitText}>Vocabulary</Text>
      </TouchableOpacity>
      <TouchableOpacity style= {styles.unitTwoContainer}>
        <Text style={styles.unitText}>Comprehension</Text>
      </TouchableOpacity>
      <TouchableOpacity style= {styles.unitThreeContainer}>
        <Text style={styles.unitText}>Phonics</Text>
      </TouchableOpacity>
      <TouchableOpacity style= {styles.unitFourContainer}>
        <Text style={styles.unitText}>Sequencing</Text>
      </TouchableOpacity>
    </View>
  );
};
